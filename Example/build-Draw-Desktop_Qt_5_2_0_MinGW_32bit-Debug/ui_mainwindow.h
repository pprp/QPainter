...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/image/rotate.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRotate->setIcon(icon2);
        actionStretch = new QAction(MainWindow);
        actionStretch->setObjectName(QStringLiteral("actionStretch"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/image/cursor-sizeall.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionStretch->setIcon(icon3);
        ...
        actionZoomIn_2 = new QAction(MainWindow);
        actionZoomIn_2->setObjectName(QStringLiteral("actionZoomIn_2"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/image/zoomin.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionZoomIn_2->setIcon(icon4);
        ...
        mainToolBar->addAction(actionZoomIn_2);
        ...
        menuEdit->addAction(actionReturn);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionZoomIn_2->setText(QApplication::translate("MainWindow", "ZoomIn", 0));
