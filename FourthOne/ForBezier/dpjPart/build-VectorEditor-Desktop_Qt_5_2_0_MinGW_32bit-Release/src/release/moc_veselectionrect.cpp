...
#include "../../../../../vector-editor_changed/vector-editor_changed/src/veselectionrect.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VESelectionRect_t, stringdata) + ofs \
...
const QMetaObject VESelectionRect::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VESelectionRect.data,
      qt_meta_data_VESelectionRect,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VESelectionRect.stringdata))
        return static_cast<void*>(const_cast< VESelectionRect*>(this));
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< VESelectionRect*>(this));
