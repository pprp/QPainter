...
void VBezierCurve::drawCR(QPainter * painter, const VTransform &transform, double scale, bool isExtended = true)
{
    VPointGroupShape::drawCR(painter,transform,scale,isExtended);
    painter->save();
    QPen pen;
